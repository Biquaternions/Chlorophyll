...
paperweight {
    upstreams.register("pufferfish") {
        ...
        patchFile {
            ...
            outputFile = file("chlorophyll-server/build.gradle.kts")
            patchFile = file("chlorophyll-server/build.gradle.kts.patch")
        }
        patchFile {
            path = "pufferfish-api/build.gradle.kts"
            outputFile = file("chlorophyll-api/build.gradle.kts")
            patchFile = file("chlorophyll-api/build.gradle.kts.patch")
        }
        patchRepo("paperApi") {
            upstreamPath = "paper-api"
            patchesDir = file("chlorophyll-api/paper-patches")
        ...
        patchDir("pufferfishApi") {
            ...
            patchesDir = file("chlorophyll-api/pufferfish-patches")
...
tasks.register("printChlorophyllVersion") {
    doLast {
